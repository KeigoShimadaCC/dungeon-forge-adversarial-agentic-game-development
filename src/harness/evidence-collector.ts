...
import { commandEvidenceStatus, type CommandExecutionResult } from './command-executor.js';
...
import type { GitStatus } from './git-adapter.js';
import type { RemoteChecksMetadata } from './github-cli-adapter.js';
